...
from .models import  Popular_categories, Hot_deals, digital_products,  Latest_blogs, Brand_logo, Slider_products, Banner_products

# Register your models here.
admin.site.register(digital_products)
