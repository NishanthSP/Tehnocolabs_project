...
class Hot_deals(models.Model):
    ...
    image = models.ImageField(upload_to = 'cosmetic_product')
...
class Latest_blogs(models.Model):
    ...
    image = models.ImageField(upload_to = 'cosmetic_blogs')
...
class Slider_products(models.Model):
    ...
    image = models.ImageField(upload_to = 'cosmetic_slider_products')

class Banner_products(models.Model):
    image = models.ImageField(upload_to = 'cosmetic_banner_products')

class Brand_logo(models.Model):
    logo_image = models.ImageField(upload_to = 'cosmetic_brand_logo')
